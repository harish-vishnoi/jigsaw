...
$(document).ready(function () {
    ...
    //reset puzzle
    $('#tryAgain').off('click').on('click', function () {
        startGame();
    });
    ...
    function startGame(){
        ...
        $('#startPuzzleHolder').hide();
        $('#restartPuzzleHolder').hide();
        $('.puzzleX999_paddedWrap').css({opacity: 1});
        setTimer();
        start_puzzleX999(puzzle_grid);
    }
    ...
    function getKompletionTime_str(puzzle_startTime, puzzle_endTime) {
        ...
        setTimeout(function () {
            ...
            $('#Timer').hide();
            $("#timeTakenDiv").text($('#Timer').text());
            $('#restartPuzzleHolder').show();
    ...
    function setTimer() {
        ...
        interval  = setInterval(function () {
            var timeTaken = new Date - start,
                ...
                kompletionTime_str = '';
            console.log(puzzle_endTime);
            kompletionTime_str = setMinutes_str(minutes)+ ":" + (seconds < 10 ? '0' + seconds : seconds) 

            $('#Timer').text(kompletionTime_str);
        }, 1000);

        function setHours_str(hours) { return hours < 1 ? '' : hours + ' hrs. '; }
        function setMinutes_str(minutes) { return minutes < 1 ? '00' : '0'+ minutes}
    }
